...
static struct simple_udp_connection connection; //para conexion udp
...
PROCESS_THREAD(sink_node, ev, data){
    ...
    NETSTACK_ROUTING.root_start(); //nodo raiz- Sink, primero en enviar mensajes y aterrizado.

    //Registro, llama afuncion callback cuando llega un pack
