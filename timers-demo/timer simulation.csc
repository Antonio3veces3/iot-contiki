...
<simconf>
  ...
  <simulation>
    <title>Timers Demo Simulation</title>
    ...
    <motetype>
      ...
      <description>Timer Mote</description>
      <source>[CONTIKI_DIR]/iot/timers-demo/timers-demo.c</source>
      <commands>make timers-demo.cooja TARGET=cooja</commands>
    ...
    <mote>
      <interface_config>
        ...
        <x>6.611906490782071</x>
        <y>97.69060021553965</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>0.7575757575757573 0.0 0.0 0.7575757575757573 83.12402016184986 -19.602599601961614</viewport>
    </plugin_config>
    <width>191</width>
    <z>1</z>
    <height>170</height>
